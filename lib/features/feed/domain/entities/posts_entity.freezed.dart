...
/// @nodoc
abstract class _$$_PostsCopyWith<$Res> implements $PostsEntityCopyWith<$Res> {
...
class __$$_PostsCopyWithImpl<$Res>
    extends _$PostsEntityCopyWithImpl<$Res, _$_Posts>
...
class _$_Posts implements _Posts {
  const _$_Posts({final List<PostEntity>? posts}) : _posts = posts;
  ...
  @override
  String toString() {
    return 'PostsEntity(posts: $posts)';
  }
...
abstract class _Posts implements PostsEntity {
  const factory _Posts({final List<PostEntity>? posts}) = _$_Posts;
